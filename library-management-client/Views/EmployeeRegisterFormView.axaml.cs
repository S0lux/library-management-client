...
{
    public partial class EmployeeRegisterFormView : Window
    {
        public EmployeeRegisterFormView(EmployeeRegisterFormViewModel employeeRegisterFormViewModel)
        {
            InitializeComponent();
            DataContext = employeeRegisterFormViewModel;
        }
        ...
        {
            var viewModel = App.AppHost.Services.GetRequiredService<EmployeeRegisterFormViewModel>();
